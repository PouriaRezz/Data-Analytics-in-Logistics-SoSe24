...
Es werden die am wenigsten frequentierten 20 % der Routen entfernt. Dabei werden Routen entfernt, die von weniger als
**
...
=== Entfernen von unvollständig dokumentierten Los
...
TODO: Warten auf aktualisierte Daten mit `OWNER` Spalte
