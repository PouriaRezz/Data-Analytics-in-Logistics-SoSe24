...
* SORTER_JOB_COMPLETE_INCON_SRC: Dies ist das Ergebnis eines Sortierschritts. Ein Wert größer als 1 kennzeichnet eine Losintegritätsverletzung.footnote:[OPAL-Kurs: Wiki: Rohdaten: SMN]
